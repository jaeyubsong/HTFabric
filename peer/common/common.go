...
import (
	...
	fastConfig "github.com/hyperledger/fabric/fastfabric/config"
...
func InitCmd(cmd *cobra.Command, args []string) {
	...
	if fastConfig.IsEndorser{
		fmt.Printf("This is endorser with core: %d\n", viper.GetInt("peer.endorserGoMaxProcs"))
		// runtime.GOMAXPROCS(viper.GetInt("peer.endorserGoMaxProcs"))
		runtime.GOMAXPROCS(40)
	} else {
		fmt.Printf("This is fast peer\n")
