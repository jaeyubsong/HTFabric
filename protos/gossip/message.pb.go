...
type CatchUpSignal_Type int32

const (
	CatchUpSignal_START CatchUpSignal_Type = 0
	CatchUpSignal_BODY  CatchUpSignal_Type = 1
	CatchUpSignal_STOP  CatchUpSignal_Type = 2
)

var CatchUpSignal_Type_name = map[int32]string{
	0: "START",
	1: "BODY",
	2: "STOP",
}

var CatchUpSignal_Type_value = map[string]int32{
	"START": 0,
	"BODY":  1,
	"STOP":  2,
}

func (x CatchUpSignal_Type) String() string {
	return proto.EnumName(CatchUpSignal_Type_name, int32(x))
}

func (CatchUpSignal_Type) EnumDescriptor() ([]byte, []int) {
...
func (GossipMessage_Tag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_24518b295636120e, []int{5, 0}
}
...
type CatchUpSignal struct {
	Type                 CatchUpSignal_Type `protobuf:"varint,1,opt,name=type,proto3,enum=gossip.CatchUpSignal_Type" json:"type,omitempty"`
...
func (m *CatchUpSignal) Reset()         { *m = CatchUpSignal{} }
func (m *CatchUpSignal) String() string { return proto.CompactTextString(m) }
func (*CatchUpSignal) ProtoMessage()    {}
func (*CatchUpSignal) Descriptor() ([]byte, []int) {
	return fileDescriptor_24518b295636120e, []int{3}
}

func (m *CatchUpSignal) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CatchUpSignal.Unmarshal(m, b)
}
func (m *CatchUpSignal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CatchUpSignal.Marshal(b, m, deterministic)
}
func (m *CatchUpSignal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CatchUpSignal.Merge(m, src)
}
func (m *CatchUpSignal) XXX_Size() int {
	return xxx_messageInfo_CatchUpSignal.Size(m)
}
func (m *CatchUpSignal) XXX_DiscardUnknown() {
	xxx_messageInfo_CatchUpSignal.DiscardUnknown(m)
}

var xxx_messageInfo_CatchUpSignal proto.InternalMessageInfo

func (m *CatchUpSignal) GetType() CatchUpSignal_Type {
	if m != nil {
		return m.Type
	}
	return CatchUpSignal_START
}

func (m *CatchUpSignal) GetBlockId() uint64 {
	if m != nil {
		return m.BlockId
	}
	return 0
...
func (m *CatchUpSignal) GetPayload() []byte {
	if m != nil {
		return m.Payload
	}
	return nil
...
type ResimulationResult struct {
	BlockId              uint64                `protobuf:"varint,1,opt,name=block_id,json=blockId,proto3" json:"block_id,omitempty"`
	TransactionId        string                `protobuf:"bytes,2,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"`
	RwSet                *rwset.TxReadWriteSet `protobuf:"bytes,3,opt,name=rw_set,json=rwSet,proto3" json:"rw_set,omitempty"`
	KeyMetadataList      []*peer.KeyMetadata   `protobuf:"bytes,4,rep,name=key_metadata_list,json=keyMetadataList,proto3" json:"key_metadata_list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}

func (m *ResimulationResult) Reset()         { *m = ResimulationResult{} }
func (m *ResimulationResult) String() string { return proto.CompactTextString(m) }
func (*ResimulationResult) ProtoMessage()    {}
func (*ResimulationResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_24518b295636120e, []int{4}
}

func (m *ResimulationResult) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ResimulationResult.Unmarshal(m, b)
}
func (m *ResimulationResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ResimulationResult.Marshal(b, m, deterministic)
}
func (m *ResimulationResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResimulationResult.Merge(m, src)
}
func (m *ResimulationResult) XXX_Size() int {
	return xxx_messageInfo_ResimulationResult.Size(m)
}
func (m *ResimulationResult) XXX_DiscardUnknown() {
	xxx_messageInfo_ResimulationResult.DiscardUnknown(m)
}

var xxx_messageInfo_ResimulationResult proto.InternalMessageInfo

func (m *ResimulationResult) GetBlockId() uint64 {
	if m != nil {
		return m.BlockId
	}
	return 0
...
func (m *ResimulationResult) GetTransactionId() string {
	if m != nil {
...
func (m *ResimulationResult) GetRwSet() *rwset.TxReadWriteSet {
	if m != nil {
		return m.RwSet
	}
	return nil
...
func (m *ResimulationResult) GetKeyMetadataList() []*peer.KeyMetadata {
	if m != nil {
		return m.KeyMetadataList
	}
	return nil
}
...
type GossipMessage struct {
	...
	// 완료된 JTODO (200917) endorsement peer가 다시 시뮬레이션한 트랜잭션을 fast peer로 보내는 행위에 대한 통신 명세를 여기에 적어야 한다.
	//
	// Types that are valid to be assigned to Content:
	//	*GossipMessage_ResimulationResult
	//	*GossipMessage_CatchUpSignal
...
type GossipMessage_ResimulationResult struct {
	ResimulationResult *ResimulationResult `protobuf:"bytes,26,opt,name=resimulation_result,json=resimulationResult,proto3,oneof"`
}

type GossipMessage_CatchUpSignal struct {
	CatchUpSignal *CatchUpSignal `protobuf:"bytes,27,opt,name=catch_up_signal,json=catchUpSignal,proto3,oneof"`
}
...
func (*GossipMessage_ResimulationResult) isGossipMessage_Content() {}

func (*GossipMessage_CatchUpSignal) isGossipMessage_Content() {}
...
func (m *GossipMessage) GetResimulationResult() *ResimulationResult {
	if x, ok := m.GetContent().(*GossipMessage_ResimulationResult); ok {
		return x.ResimulationResult
	}
	return nil
}

func (m *GossipMessage) GetCatchUpSignal() *CatchUpSignal {
	if x, ok := m.GetContent().(*GossipMessage_CatchUpSignal); ok {
		return x.CatchUpSignal
	}
	return nil
}
...
func (*GossipMessage) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*GossipMessage_ResimulationResult)(nil),
		(*GossipMessage_CatchUpSignal)(nil),
...
func init() {
	...
	proto.RegisterEnum("gossip.CatchUpSignal_Type", CatchUpSignal_Type_name, CatchUpSignal_Type_value)
	...
	proto.RegisterType((*CatchUpSignal)(nil), "gossip.CatchUpSignal")
	proto.RegisterType((*ResimulationResult)(nil), "gossip.ResimulationResult")
...
var fileDescriptor_24518b295636120e = []byte{
	...
	,
}
