...
type KeyMetadata struct {
	...
	// uint32 degree = 3;
	// Hubness hubness = 4;
	Writing              bool     `protobuf:"varint,5,opt,name=writing,proto3" json:"writing,omitempty"`
...
func (m *KeyMetadata) GetName() []byte {
	if m != nil {
		return m.Name
	}
	return nil
...
func (m *KeyMetadata) GetWriting() bool {
	if m != nil {
		return m.Writing
	}
	return false
...
func (m *KeyMetadata) GetValue() int64 {
	if m != nil {
		return m.Value
	}
	return 0
...
type Response struct {
	...
	KeyMetadataList      []*KeyMetadata `protobuf:"bytes,4,rep,name=key_metadata_list,json=keyMetadataList,proto3" json:"key_metadata_list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *Response) GetKeyMetadataList() []*KeyMetadata {
	if m != nil {
...
func init() {
	proto.RegisterType((*KeyMetadata)(nil), "protos.KeyMetadata")
...
var fileDescriptor_2ed51030656d961a = []byte{
	...
	,
}
