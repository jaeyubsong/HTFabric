def execute(rwset, args):
    if len(args) == 4:
        ...
        acc3_value = int(rwset[0][account3])
        acc4_value = int(rwset[0][account4])
        rwset[1][account5] = str(acc1_value)
        rwset[1][account6] = str(acc2_value)
        rwset[1][account7] = str(acc3_value)
        rwset[1][account8] = str(acc4_value)
    elif len(args) == 17:
        account1 = args[1]
        account2 = args[2]
        account3 = args[3]
        ...
        acc7_value = int(rwset[0][account7])
        acc8_value = int(rwset[0][account8])
        rwset[1][account9] = str(acc1_value)
        rwset[1][account10] = str(acc2_value)
        rwset[1][account11] = str(acc3_value)
        rwset[1][account12] = str(acc4_value)
        rwset[1][account13] = str(acc5_value)
        rwset[1][account14] = str(acc6_value)
        rwset[1][account15] = str(acc7_value)
        rwset[1][account16] = str(acc8_value)
    else:
        account1 = args[0]
        account2 = args[1]
