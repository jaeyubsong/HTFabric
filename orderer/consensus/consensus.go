...
type ConsenterSupport interface {
	...
	CreateNextBlockParallel(messages []*cb.Envelope, partition_info []byte, prevBlockHash []byte, prevBlockNum uint64) *cb.Block
	...
	WriteBlockParallel(block *cb.Block, encodedMetadataValue []byte, lastBlock *cb.Block)
