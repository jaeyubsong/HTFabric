...
var (
	...
	heapAllocGaugeOptsE     = metrics.GaugeOpts{Namespace: "go", Subsystem: "mem", Name: "endorser_heap_alloc_bytes"}
	heapAllocGaugeOptsS     = metrics.GaugeOpts{Namespace: "go", Subsystem: "mem", Name: "storage_heap_alloc_bytes"}
